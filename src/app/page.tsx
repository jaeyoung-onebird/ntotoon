        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link
              ...
              className="px-4 sm:px-6 py-2 sm:py-3 bg-white text-blue-700 font-bold rounded-xl hover:bg-blue-50 transition-all shadow-lg text-sm sm:text-base whitespace-nowrap flex-shrink-0"
            >
              + 웹툰 만들기
            </Link>
          </div>
